...
open class GenPagesUserWallet : BasePage {
        ...
        return createElementVNode("view", utsMapOf("class" to "page"), utsArrayOf(
            createElementVNode("view", utsMapOf("class" to "header-bg"), utsArrayOf(
                ...
                createElementVNode("view", utsMapOf("class" to "nav-bar"), utsArrayOf(
                    ...
                    createElementVNode("text", utsMapOf("class" to "nav-title"), "我的钱包"),
                    createElementVNode("view", utsMapOf("class" to "nav-action", "onClick" to _ctx.showHelp), utsArrayOf(
                        createElementVNode("text", utsMapOf("class" to "nav-action-text"), "说明")
                    ), 8, utsArrayOf(
                        "onClick"
                    ))
                )),
                createElementVNode("view", utsMapOf("class" to "balance-box"), utsArrayOf(
                    createElementVNode("view", utsMapOf("class" to "balance-header"), utsArrayOf(
                        createElementVNode("text", utsMapOf("class" to "balance-label"), "账户余额(元)"),
                    ...
                    createElementVNode("view", utsMapOf("class" to "balance-amount"), utsArrayOf(
                        ...
                        createElementVNode("text", utsMapOf("class" to "amount-num"), toDisplayString(if (_ctx.showBalance) {
                            _ctx.formatMoney(_ctx.walletInfo.balance)
                        } else {
                            "****"
                        }
                        ), 1)
                    ...
                    createElementVNode("view", utsMapOf("class" to "balance-actions"), utsArrayOf(
                        createElementVNode("view", utsMapOf("class" to "action-btn-primary", "onClick" to _ctx.handleRecharge), utsArrayOf(
                            createElementVNode("text", utsMapOf("class" to "action-btn-primary-text"), "充值")
                        ), 8, utsArrayOf(
                            "onClick"
                        )),
                        createElementVNode("view", utsMapOf("class" to "action-btn-outline", "onClick" to _ctx.handleWithdraw), utsArrayOf(
                            createElementVNode("text", utsMapOf("class" to "action-btn-outline-text"), "提现")
                        ), 8, utsArrayOf(
                            "onClick"
                        ))
                    ))
            ...
            createElementVNode("scroll-view", utsMapOf("class" to "main-scroll", "scroll-y" to "true", "show-scrollbar" to false, "onScrolltolower" to _ctx.loadMore), utsArrayOf(
                createElementVNode("view", utsMapOf("class" to "stats-card"), utsArrayOf(
                    createElementVNode("view", utsMapOf("class" to "stats-item"), utsArrayOf(
                        createElementVNode("text", utsMapOf("class" to "stats-num"), toDisplayString(_ctx.formatMoney(_ctx.walletInfo.frozenAmount)), 1),
                        createElementVNode("text", utsMapOf("class" to "stats-name"), "冻结金额")
                    )),
                    createElementVNode("view", utsMapOf("class" to "stats-divider")),
                    createElementVNode("view", utsMapOf("class" to "stats-item"), utsArrayOf(
                        createElementVNode("text", utsMapOf("class" to "stats-num stats-num-green"), toDisplayString(_ctx.formatMoney(_ctx.walletInfo.totalRecharge)), 1),
                        createElementVNode("text", utsMapOf("class" to "stats-name"), "累计充值")
                    )),
                    createElementVNode("view", utsMapOf("class" to "stats-divider")),
                    createElementVNode("view", utsMapOf("class" to "stats-item"), utsArrayOf(
                        createElementVNode("text", utsMapOf("class" to "stats-num stats-num-orange"), toDisplayString(_ctx.formatMoney(_ctx.walletInfo.totalConsume)), 1),
                        createElementVNode("text", utsMapOf("class" to "stats-name"), "累计消费")
                    ))
                )),
                createElementVNode("view", utsMapOf("class" to "record-card"), utsArrayOf(
                    createElementVNode("view", utsMapOf("class" to "record-header"), utsArrayOf(
                        ...
                        createElementVNode("view", utsMapOf("class" to "filter-tabs"), utsArrayOf(
                            ...
                            createElementVNode("text", utsMapOf("class" to normalizeClass(utsArrayOf(
                                "filter-tab",
                                utsMapOf("filter-tab-active" to (_ctx.currentFilter == "in"))
                            )), "onClick" to fun(){
                                _ctx.changeFilter("in")
                            }
                            ), "收入", 10, utsArrayOf(
                                "onClick"
                            )),
                            createElementVNode("text", utsMapOf("class" to normalizeClass(utsArrayOf(
                                "filter-tab",
                                utsMapOf("filter-tab-active" to (_ctx.currentFilter == "out"))
                            )), "onClick" to fun(){
                                _ctx.changeFilter("out")
                            }
                            ), "支出", 10, utsArrayOf(
                                "onClick"
                            ))
                    ...
                    if (isTrue(_ctx.isLoading && _ctx.records.length == 0)) {
                        ...
                        createElementVNode("view", utsMapOf("key" to 1, "class" to "record-list"), utsArrayOf(
                            createElementVNode(Fragment, null, RenderHelpers.renderList(_ctx.records, fun(item, index, __index, _cached): Any {
                    ...
                    if (isTrue(!_ctx.isLoading && _ctx.records.length == 0)) {
                        createElementVNode("view", utsMapOf("key" to 3, "class" to "empty-box"), utsArrayOf(
                            ...
                            createElementVNode("text", utsMapOf("class" to "empty-text"), "暂无记录")
                        ))
                    } else {
                        createCommentVNode("v-if", true)
                    }
            ...
            if (isTrue(_ctx.showRechargeModal)) {
                createElementVNode("view", utsMapOf("key" to 0, "class" to "modal-mask", "onClick" to _ctx.closeRechargeModal), utsArrayOf(
                    createElementVNode("view", utsMapOf("class" to "modal-content", "onClick" to withModifiers(fun(){}, utsArrayOf(
                        "stop"
                    ))), utsArrayOf(
                        createElementVNode("text", utsMapOf("class" to "modal-title"), "充值金额"),
                        createElementVNode("view", utsMapOf("class" to "amount-options"), utsArrayOf(
                            createElementVNode("view", utsMapOf("class" to normalizeClass(utsArrayOf(
                                "amount-option",
                                utsMapOf("amount-option-active" to (_ctx.selectedAmount == 50))
                            )), "onClick" to fun(){
                                _ctx.selectAmount(50)
                            }), utsArrayOf(
                                createElementVNode("text", utsMapOf("class" to "option-text"), "50元")
                            ), 10, utsArrayOf(
                                "onClick"
                            )),
                            createElementVNode("view", utsMapOf("class" to normalizeClass(utsArrayOf(
                                "amount-option",
                                utsMapOf("amount-option-active" to (_ctx.selectedAmount == 100))
                            )), "onClick" to fun(){
                                _ctx.selectAmount(100)
                            }), utsArrayOf(
                                createElementVNode("text", utsMapOf("class" to "option-text"), "100元")
                            ), 10, utsArrayOf(
                                "onClick"
                            )),
                            createElementVNode("view", utsMapOf("class" to normalizeClass(utsArrayOf(
                                "amount-option",
                                utsMapOf("amount-option-active" to (_ctx.selectedAmount == 200))
                            )), "onClick" to fun(){
                                _ctx.selectAmount(200)
                            }), utsArrayOf(
                                createElementVNode("text", utsMapOf("class" to "option-text"), "200元")
                            ), 10, utsArrayOf(
                                "onClick"
                            )),
                            createElementVNode("view", utsMapOf("class" to normalizeClass(utsArrayOf(
                                "amount-option",
                                utsMapOf("amount-option-active" to (_ctx.selectedAmount == 500))
                            )), "onClick" to fun(){
                                _ctx.selectAmount(500)
                            }), utsArrayOf(
                                createElementVNode("text", utsMapOf("class" to "option-text"), "500元")
                            ), 10, utsArrayOf(
                                "onClick"
                            ))
                        )),
                        createElementVNode("view", utsMapOf("class" to "custom-input-box"), utsArrayOf(
                            createElementVNode("text", utsMapOf("class" to "input-label"), "自定义金额"),
                            createElementVNode("input", utsMapOf("class" to "custom-input", "type" to "digit", "placeholder" to "请输入金额", "modelValue" to _ctx.customAmount, "onInput" to fun(`$event`: InputEvent){
                                _ctx.customAmount = `$event`.detail.value
                            }, "onBlur" to _ctx.onCustomInput), null, 40, utsArrayOf(
                                "modelValue",
                                "onInput",
                                "onBlur"
                            ))
                        ...
                        createElementVNode("view", utsMapOf("class" to "modal-actions"), utsArrayOf(
                            createElementVNode("view", utsMapOf("class" to "modal-btn modal-btn-cancel", "onClick" to _ctx.closeRechargeModal), utsArrayOf(
                                createElementVNode("text", utsMapOf("class" to "btn-text"), "取消")
                            ), 8, utsArrayOf(
                                "onClick"
                            )),
                            createElementVNode("view", utsMapOf("class" to "modal-btn modal-btn-confirm", "onClick" to _ctx.confirmRecharge), utsArrayOf(
                                createElementVNode("text", utsMapOf("class" to "btn-text-white"), "确认充值")
                            ), 8, utsArrayOf(
                                "onClick"
                            ))
                        ))
    ...
    open var walletInfo: WalletVO by `$data`
    open var records: UTSArray<TransactionVO> by `$data`
    open var pageNum: Number by `$data`
    open var pageSize: Number by `$data`
    open var hasMore: Boolean by `$data`
    open var showRechargeModal: Boolean by `$data`
    open var selectedAmount: Number by `$data`
    open var customAmount: String by `$data`
    @Suppress("USELESS_CAST")
    override fun data(): Map<String, Any?> {
        return utsMapOf("isLoading" to false, "showBalance" to true, "currentFilter" to "all", "walletInfo" to WalletVO(id = 0, userId = 0, balance = 0, frozenAmount = 0, totalRecharge = 0, totalConsume = 0), "records" to utsArrayOf<TransactionVO>(), "pageNum" to 1, "pageSize" to 10, "hasMore" to true, "showRechargeModal" to false, "selectedAmount" to 100, "customAmount" to "")
    }
    open var loadWalletInfo = ::gen_loadWalletInfo_fn
    open fun gen_loadWalletInfo_fn() {
        getWallet().then(fun(res){
            val data = res.data as UTSJSONObject
            this.walletInfo = WalletVO(id = (data.getNumber("id") ?: 0).toInt(), userId = (data.getNumber("userId") ?: 0).toInt(), balance = data.getNumber("balance") ?: 0, frozenAmount = data.getNumber("frozenAmount") ?: 0, totalRecharge = data.getNumber("totalRecharge") ?: 0, totalConsume = data.getNumber("totalConsume") ?: 0)
        }
        ).`catch`(fun(err){
    ...
    open fun gen_loadTransactions_fn() {
        ...
        getTransactions(TransactionQueryParams(type = typeParam, startDate = null, endDate = null, pageNum = this.pageNum, pageSize = this.pageSize)).then(fun(res){
            val data = res.data as UTSJSONObject
            val recordsArr = data.getArray("records")
            val total = (data.getNumber("total") ?: 0).toInt()
            if (recordsArr != null) {
                val newRecords: UTSArray<TransactionVO> = utsArrayOf()
                run {
                    var i: Number = 0
                    while(i < recordsArr.length){
                        val item = recordsArr[i] as UTSJSONObject
                        newRecords.push(TransactionVO(id = (item.getNumber("id") ?: 0).toInt(), transactionNo = item.getString("transactionNo") ?: "", type = item.getString("type") ?: "", typeDesc = item.getString("typeDesc") ?: "", amount = item.getNumber("amount") ?: 0, balanceAfter = item.getNumber("balanceAfter") ?: 0, relatedOrderNo = item.getString("relatedOrderNo"), description = item.getString("description") ?: "", createTime = item.getString("createTime") ?: ""))
                        i++
                    }
                }
                if (this.pageNum == 1) {
    ...
    open fun gen_changeFilter_fn(filter: String) {
        ...
        this.pageNum = 1
        this.records = utsArrayOf<TransactionVO>()
        this.hasMore = true
        this.loadTransactions()
    }
    ...
    open var showHelp = ::gen_showHelp_fn
    open fun gen_showHelp_fn() {
        uni_showModal(ShowModalOptions(title = "余额说明", content = "账户余额可用于支付订单。充值金额不可提现，退款金额可原路返回。", showCancel = false))
    }
    open var handleRecharge = ::gen_handleRecharge_fn
    open fun gen_handleRecharge_fn() {
        this.showRechargeModal = true
        this.selectedAmount = 100
        this.customAmount = ""
    }
    open var closeRechargeModal = ::gen_closeRechargeModal_fn
    open fun gen_closeRechargeModal_fn() {
        this.showRechargeModal = false
    }
    open var selectAmount = ::gen_selectAmount_fn
    open fun gen_selectAmount_fn(amount: Number) {
        this.selectedAmount = amount
        this.customAmount = ""
    }
    open var onCustomInput = ::gen_onCustomInput_fn
    open fun gen_onCustomInput_fn() {
        if (this.customAmount != "") {
            this.selectedAmount = 0
        }
    }
    open var confirmRecharge = ::gen_confirmRecharge_fn
    open fun gen_confirmRecharge_fn() {
        var amount = this.selectedAmount
        if (this.customAmount != "") {
            amount = parseFloat(this.customAmount)
            if (isNaN(amount) || amount <= 0) {
                uni_showToast(ShowToastOptions(title = "请输入有效金额", icon = "none"))
                return
            }
        }
        if (amount <= 0) {
            uni_showToast(ShowToastOptions(title = "请选择充值金额", icon = "none"))
            return
        }
        uni_showLoading(ShowLoadingOptions(title = "充值中..."))
        rechargeWallet(amount).then(fun(_res){
            uni_hideLoading()
            uni_showToast(ShowToastOptions(title = "充值成功", icon = "success"))
    ...
    open fun gen_getIconClass_fn(type: String): String {
        if (type == "RECHARGE" || type == "ADMIN_RECHARGE") {
            return "item-icon-recharge"
        }
        if (type == "PAYMENT") {
            return "item-icon-pay"
        }
        if (type == "REFUND") {
